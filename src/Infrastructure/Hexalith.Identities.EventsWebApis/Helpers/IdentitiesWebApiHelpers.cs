...
using Hexalith.Identities.EventsWebApis.Users.Controllers;
using Hexalith.Identities.EventsWebApis.Users.Projections;
...
public static class IdentitiesWebApiHelpers
{
    ...
    public static IServiceCollection AddUserProjections(this IServiceCollection services, string applicationId)
    {
        ...
        services.TryAddScoped<IProjectionUpdateHandler<SnapshotEvent>, UserSnapshotHandler>();
